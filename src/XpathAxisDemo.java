...
public class XpathAxisDemo {
	public static void main(String[] args) {
		...
		// bye kelimesini id ile bulmak icin // means anywhere in page p=paragraf
		// @id=attribute ve koseli parantezle bul.
		// bye text oldugu icin get.text ile cagir
		WebElement bye = driver.findElement(By.xpath("//p[@id='bye']"));
		System.out.println(bye.getText());

		// ancestor kismina ulasmak icin usttekinin aynisini yazip sonuna slash ancestor
		// yazip double iki nokta yazip
		// ilk parent icin 1 yazariz alip almadigimizi anlamak icinde get.Attribute
		// yazariz. 0 sayisi yoktur.
		...
		// Eger tag onemli degil sadece parenti bulmak istiyorsak slashtan sonra sadece
		// parent::* yazilir.Just give me the parent
