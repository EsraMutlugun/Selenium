...
public class FindElementDemo {
	...
	@Test
	// Check search button with by.name if there is more than one in same name
	// always return the first one.
	// If <input type="text" value ="hello/> there isn't child and should use
	...
	@Test
	// Find all elements by tag names use for loop to check all of them FindElements
	// search a list
