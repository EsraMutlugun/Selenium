...
public class BmiTest {
	...
	//Once parameterslari okur daha sonra row row buraya gelir.Mapping yapar bu nedenle parametic metodu static olmali
	...
	public void setUp() {
		...
		driver = new ChromeDriver();driver.get("http://localhost:8080/workspace/bmicalculator.html");
		}
