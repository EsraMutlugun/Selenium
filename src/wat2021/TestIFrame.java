...
//Bazen koslar iframe denilen sayfanin icinde ekstra bir framede bulunabilir
public class TestIFrame {
	...
	public void testIFrame() {
		//WebElementi bulup oradan gitmek daha garanti yoldur.
		WebElement iframe = driver.findElement(By.cssSelector("iframe[src$='button.html']"));
		driver.switchTo().frame(iframe);
		
		
		// I am in the iframe
		//Simdi oradaki buttonu bulup clik etmem lazim
		WebElement btn = driver.findElement(By.cssSelector("[value='Click Me']"));
		btn.click();
		
		//click ettikten sonra beklemek daha garantilidir cunku alert dedigimiz mesaj gelecek
